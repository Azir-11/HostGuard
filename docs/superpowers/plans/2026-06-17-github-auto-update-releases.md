      ...
      <div class="flex flex-col gap-10px px-18px py-14px border-t border-hairline">
        <div class="flex items-center justify-between gap-16px">
          ...
          <button
            ...
            @click="onCheck"
          >
            <span :class="status === 'checking' ? 'i-ph-spinner-duotone animate-spin' : 'i-ph-arrows-clockwise-bold'" />
          ...
          <span
            v-else
            class="inline-flex items-center gap-6px px-14px py-7px text-13px text-fg-3"
          >
